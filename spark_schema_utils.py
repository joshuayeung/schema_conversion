...
def add_missing_columns(df: DataFrame, schema: StructType) -> DataFrame:
    ...
    def get_field_expr(field: StructField, prefix: str = "", existing_field: StructField = None) -> str:
        ...
        if isinstance(field_type, StructType):
            # Get existing struct type if available
            ...
            for subfield in field_type.fields:
                ...
                if existing_subfield:
                    # If subfield exists, recursively process it to handle nested subfields
                    ...
                    # If subfield is missing, generate a NULL expression for it
                    subfield_expr = get_field_expr(
                        subfield,
                        f"{field_name}." if field_name else "",
                        None
            ...
            # Always construct a new struct with all subfields
